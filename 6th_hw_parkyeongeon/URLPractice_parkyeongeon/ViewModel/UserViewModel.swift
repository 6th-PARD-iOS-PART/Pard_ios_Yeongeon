...
final class UserViewModel: ObservableObject {
    ...
    //MARK: - post
    //"postUser" 함수를 작성하시오.
    public func postUser(data: postUserModel) async {
        let urlString = BaseURL.baseUrl.rawValue
        ...
        let newUser = postUserModel(id: nil, user_name: data.user_name, user_age: data.user_age, pard_part: data.pard_part)
    ...
    public func updateUser(id: Int, data: postUserModel) async {
        let urlString = BaseURL.baseUrl.rawValue
